    ...
    fun verifyEmailAndReSendOtp (email : String)
    {
        viewModelScope.launch {
            ...
            result.onSuccess { key ->
                ...
                _forgotPasswordStatus.value = ForgotPasswordStatus.Error(ErrorType.CHECK_EMAIL,error.message.toString())
            }
        }
    }
    fun checkOTP(otp : String)
    {
        viewModelScope.launch {
            ...
            result.onSuccess {
                ...
                _forgotPasswordStatus.value = ForgotPasswordStatus.Error(ErrorType.CHECK_OTP, error.message.toString())
            }
        }
    }
    fun changePassword (password : String)
    {
        viewModelScope.launch {
            ...
            changePassword.onSuccess {
                ...
                _forgotPasswordStatus.value = ForgotPasswordStatus.Error(ErrorType.CHECK_PASSWORD, error.message.toString())
            }
        }
    }
}